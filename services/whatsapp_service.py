...
WHATSAPP_APP_ID = os.getenv("WHATSAPP_APP_ID")  # Necesario para subida reanudable
...
def send_whatsapp_template_with_media(
    ...
    if media_id:
        # Si tenemos media_id específico, usarlo
        ...
        print(f"📎 Enviando plantilla con media_id específico: {media_id}")
    else:
